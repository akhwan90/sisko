...
<div id="main" class="clearfix">
    <div id="content">
		...
		<center><h2>Rekap Siswa Per Kelas, Tahun Ajaran <?php echo date('Y')."/".(date('Y')+1)?></h2></center>
...
<tr>
	<td><?php echo $rk->agama?></td><td id="tengah"><?php echo $rk->lakiX?></td><td id="tengah"><?php echo $rk->prX?></td><td id="tengah"><?php echo $rk->jX?></td>
