...
<div id="main" class="clearfix">
    <div id="content">
		...
		<center><h2>Rekap Siswa Per Keahlian, Tahun Ajaran <?php echo date('Y')."/".(date('Y')+1)?></h2></center>

		
<table class="bordered">
<thead>
<tr>
	<th>Keahlian</th><th>X (L)</th><th>X (P)</th><th>Jumlah X</th>
...
?>
<tr>
	<td><?php echo $rk->prodi?></td><td id="tengah"><?php echo $rk->lakiX?></td><td id="tengah"><?php echo $rk->prX?></td><td id="tengah"><?php echo $rk->jX?></td>
